...
public class MessageOfTheDay implements Serializable
{
    ...
    public MessageOfTheDay(String title, String message, Date messageDate)
    {
        this.title = title;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MessageOfTheDay)) {
            return false;
        }
        MessageOfTheDay other = (MessageOfTheDay) object;
    ...
    public String toString() {
        return "entity.MessageOfTheDay[ motdId=" + motdId + " ]";
    }
